...
describe('profileSlice.test', () => {
   ...
   test('test updateFirst', () => {
      ...
      expect(profileReducer(state as ProfileSchema, profileActions.updateFirst('Admin'))).toEqual({
         form: {
            first: 'Admin',
         },
      });
   ...
   test('test updateLastname', () => {
      ...
      expect(profileReducer(state as ProfileSchema, profileActions.updateLastname('Admin'))).toEqual({
         form: {
            lastname: 'Admin',
         },
      });
   ...
   test('test updateAge', () => {
      ...
      expect(profileReducer(state as ProfileSchema, profileActions.updateAge(22))).toEqual({
         form: {
            age: 22,
         },
      });
   ...
   test('test updateCurrency', () => {
      ...
      expect(profileReducer(state as ProfileSchema, profileActions.updateCurrency(Currency.USD))).toEqual({
         form: {
   ...
   test('test updateCountry', () => {
      ...
      expect(profileReducer(state as ProfileSchema, profileActions.updateCountry(Country.Canada))).toEqual({
         form: {
   ...
   test('test updateCity', () => {
      ...
      expect(profileReducer(state as ProfileSchema, profileActions.updateCity('Sumy'))).toEqual({
         form: {
            city: 'Sumy',
         },
      });
   ...
   test('test updateUsername', () => {
      ...
      expect(profileReducer(state as ProfileSchema, profileActions.updateUsername('User'))).toEqual({
         form: {
            username: 'User',
         },
      });
   ...
   test('test updateAvatar', () => {
      ...
      expect(profileReducer(state as ProfileSchema, profileActions.updateAvatar('User'))).toEqual({
         form: {
            avatar: 'User',
         },
      });
