...
export const ArticleDetails = memo(({ className, id }: ArticleDetailsProps) => {
   ...
   if (isLoading) {
      ...
      content = <Text size={TextFontSize.L} texAlign={TextAlign.CENTER} title={t('Статья не найдена')} />;
   } else {
      content = (
         <>
            <div className={cls.header}>
               <Text className={cls.header__title} size={TextFontSize.XL} title={article?.title} />
               <div className={cls.header__avatar}>
               ...
               <div className={cls.header__content}>
                  ...
                  <div className={cls.header__block}>
                     ...
                     <Text className={cls.header__info} size={TextFontSize.L} text={String(article?.views)} />
                  </div>
                  <div className={cls.header__block}>
