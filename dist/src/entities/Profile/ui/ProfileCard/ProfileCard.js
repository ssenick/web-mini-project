...
export var ProfileCard = memo(function (props) {
    ...
    if (isLoading) {
        // return <LoaderPoints/>
        return (_jsx("div", __assign({ className: classNames(cls.ProfileCard, {}, [className]) }, { children: _jsxs("div", __assign({ className: cls.data }, { children: [_jsx(HStack, __assign({ justify: 'center' }, { children: _jsx(Skeleton, { border: '50%', height: 100, width: 100 }) })), _jsxs(VStack, __assign({ gap: '10', className: cls.row }, { children: [_jsx(Skeleton, { border: '5px', height: 23, width: 140 }), _jsxs("div", __assign({ className: cls.column }, { children: [_jsx("div", __assign({ className: cls.inputWithError }, { children: _jsx(Skeleton, { border: '5px', height: 58, width: '100%' }) })), _jsx("div", __assign({ className: cls.inputWithError }, { children: _jsx(Skeleton, { border: '5px', height: 58, width: '100%' }) })), _jsx("div", __assign({ className: cls.inputWithError }, { children: _jsx(Skeleton, { border: '5px', height: 58, width: '100%' }) })), _jsx(Skeleton, { className: cls.currency, border: '5px', height: 58, width: '100%' })] }))] })), _jsxs(VStack, __assign({ gap: '10', className: cls.row }, { children: [_jsx(Skeleton, { border: '5px', height: 23, width: 140 }), _jsxs("div", __assign({ className: cls.column }, { children: [_jsx("div", __assign({ className: cls.inputWithError }, { children: _jsx(Skeleton, { border: '5px', height: 58, width: '100%' }) })), _jsx(Skeleton, { className: cls.avatar, border: '5px', height: 58, width: '100%' }), _jsx(Skeleton, { className: cls.currency, border: '5px', height: 58, width: '100%' })] }))] }))] })) })));
    }
    if (errorServerError) {
    ...
    return (_jsx("div", __assign({ className: classNames(cls.ProfileCard, {}, [className]) }, { children: _jsxs("div", __assign({ className: cls.data }, { children: [_jsx(HStack, __assign({ justify: 'center' }, { children: (data === null || data === void 0 ? void 0 : data.avatar) && _jsx(Avatar, { src: data === null || data === void 0 ? void 0 : data.avatar }) })), _jsxs(VStack, __assign({ gap: '10', className: cls.row }, { children: [_jsx(Text, { title: t('Личные данные') }), _jsxs("div", __assign({ className: cls.column }, { children: [_jsxs("div", __assign({ className: cls.inputWithError }, { children: [_jsx(Input, { className: cls.input, label: t('Имя'), onChange: onChangeFirstName, readonly: readonly, variant: InputVariant.INVERSE_BG, value: data === null || data === void 0 ? void 0 : data.first }), errorFirstname && _jsx(Text, { className: cls.errorInput, variant: TextVariant.ERROR, size: TextFontSize.SXS, text: errorFirstname })] })), _jsxs("div", __assign({ className: cls.inputWithError }, { children: [_jsx(Input, { className: cls.input, label: t('Фамилия'), onChange: onChangeLastName, readonly: readonly, variant: InputVariant.INVERSE_BG, value: data === null || data === void 0 ? void 0 : data.lastname }), errorLastname && _jsx(Text, { className: cls.errorInput, variant: TextVariant.ERROR, size: TextFontSize.SXS, text: errorLastname })] })), _jsxs("div", __assign({ className: cls.inputWithError }, { children: [_jsx(Input, { className: cls.age, label: t('Возраст'), onChange: onChangeAge, readonly: readonly, variant: InputVariant.INVERSE_BG, value: data === null || data === void 0 ? void 0 : data.age }), errorAge && _jsx(Text, { className: cls.errorInput, variant: TextVariant.ERROR, size: TextFontSize.SXS, text: errorAge })] })), _jsx(CountrySelect, { onChange: onChangeCountry, className: cls.currency, value: data === null || data === void 0 ? void 0 : data.country, readonly: readonly })] }))] })), _jsxs(VStack, __assign({ gap: '10', className: cls.row }, { children: [_jsx(Text, { title: t('Настройки профиля') }), _jsxs("div", __assign({ className: cls.column }, { children: [_jsxs("div", __assign({ className: cls.inputWithError }, { children: [_jsx(Input, { className: cls.username, label: t('Имя пользователя'), onChange: onChangeUsername, readonly: readonly, variant: InputVariant.INVERSE_BG, value: data === null || data === void 0 ? void 0 : data.username }), errorUsername && _jsx(Text, { className: cls.errorInput, variant: TextVariant.ERROR, size: TextFontSize.SXS, text: errorUsername })] })), _jsx(Input, { className: cls.avatar, label: t('Ссылка на аватар'), onChange: onChangeAvatar, readonly: readonly, variant: InputVariant.INVERSE_BG, value: data === null || data === void 0 ? void 0 : data.avatar }), _jsx(CurrencySelect, { onChange: onChangeCurrency, className: cls.currency, value: data === null || data === void 0 ? void 0 : data.currency, readonly: readonly })] }))] }))] })) })));
});
