...
export var ListBox = memo(function (props) {
    var _a;
    var className = props.className, items = props.items, value = props.value, defaultValue = props.defaultValue, readonly = props.readonly, contentTitle = props.contentTitle, label = props.label, onChange = props.onChange;
    ...
    return (_jsxs(VStack, __assign({ gap: '5' }, { children: [label && _jsx(Text, { className: cls.label, size: TextFontSize.SXS, title: label }), _jsxs(HListbox, __assign({ value: value, onChange: onChange, disabled: readonly, as: 'div', className: classNames(cls.ListBox, {}, [className]) }, { children: [_jsx(HListbox.Button, __assign({ className: cls.button }, { children: function (_a) {
                            var _b;
                            var open = _a.open;
                            var arrowIcon = _jsx(ArrowIcon, { className: classNames('', (_b = {}, _b[cls.open] = open, _b), []) });
                            return (_jsxs(_Fragment, { children: [contentTitle ? foundItemContent : value !== null && value !== void 0 ? value : defaultValue, arrowIcon] }));
