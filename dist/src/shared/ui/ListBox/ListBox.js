...
export var ListBox = memo(function (props) {
    var _a;
    var className = props.className, items = props.items, value = props.value, _b = props.variant, variant = _b === void 0 ? ListBoxVariant.STANDARD : _b, defaultValue = props.defaultValue, readonly = props.readonly, contentTitle = props.contentTitle, label = props.label, test = props.test, onlyIcon = props.onlyIcon, onChange = props.onChange;
