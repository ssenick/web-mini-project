...
export var ArticleViewSelector = memo(function (props) {
    ...
    return (_jsx("div", __assign({ className: classNames(cls.ArticleViewSelector, {}, [className]) }, { children: viewTypes.map(function (viewType) {
            var _a;
            return _jsx(Button, __assign({ onClick: onClick(view), className: classNames(cls.button, (_a = {}, _a[cls.selected] = viewType.view === view, _a), []) }, { children: _jsx(Icon, { Svg: viewType.icon }) }), viewType.view);
        }) })));
});
