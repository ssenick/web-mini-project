...
export var Header = memo(function (_a) {
    ...
    var onLogout = useCallback(function () {
        ...
        if ((location === null || location === void 0 ? void 0 : location.pathname.substring(1)) === RoutPath.profile) {
            navigate('/');
        }
    }, [dispatch, navigate]);
    useEffect(function () {
    ...
    return (_jsxs("header", __assign({ className: classNames(cls.Header, {}, [className]) }, { children: [_jsx(AppLink, __assign({ className: cls.logo, noActive: true, to: '/', variant: AppLinkVariant.CLEAN }, { children: theme === Theme.DARK ? _jsx(LogoWhiteIcon, {}) : _jsx(LogoDarkIcon, {}) })), _jsxs("div", __assign({ className: cls.title }, { children: [" ", t('Главная')] })), _jsxs("div", __assign({ className: cls.action }, { children: [_jsx(ThemeSwitcher, {}), _jsx(Button, __assign({ onClick: onThrow, variant: ButtonVariant.BACKGROUND }, { children: t('ошибка') })), _jsx(LangSwitcher, {}), userAuth
