...
export var Header = memo(function (_a) {
    ...
    return (_jsxs("header", __assign({ className: classNames(cls.Header, {}, [className]) }, { children: [_jsxs(AppLink, __assign({ className: cls.logo, noActive: true, to: '/', variant: AppLinkVariant.CLEAN }, { children: [(theme === Theme.DARK || theme === Theme.FUNNY) && _jsx(LogoWhiteIcon, {}), theme === Theme.LIGHT && _jsx(LogoDarkIcon, {})] })), _jsxs("div", __assign({ className: cls.title }, { children: [" ", t('Главная')] })), _jsxs("div", __assign({ className: cls.action }, { children: [_jsx(ThemeSwitcher, {}), _jsx(LangSwitcher, {}), _jsx(Button, __assign({ onClick: onThrow, variant: ButtonVariant.BACKGROUND }, { children: t('ошибка') })), userAuth
