...
var App = function () {
    ...
    /// === ////////
    return (_jsx("div", __assign({ className: classNames('app', mods, []) }, { children: _jsxs(Suspense, __assign({ fallback: '' }, { children: [_jsx(Header, { className: 'app__header' }), _jsx(Sidebar, { className: 'app__sidebar' }), _jsx(AppRouter, { className: 'app__content' })] })) })));
};
export default App;
